...
export default function DatosNegocioPage() {
  ...
  return (
    <div>
      <header className="bg-emerald-600 text-white px-4 pt-4 pb-3 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-none">
          {bloqueado && (
            <button
              ...
              className="min-h-[40px] px-3.5 rounded-xl bg-white/20 flex items-center gap-1.5 font-semibold text-sm"
            >
